...
func main(arguments: [String]) -> Int32 {
    ...
    let tvSet = StringOption(
        longFlag: "tvSet",
        helpMessage: ".json file describing the TV set. (Default: TVs are internally generated by RNG. )"
    )
    ...
    guard
        ...
        let tvCeiling = Int(ceiling.value ?? (tvSet.value == nil ? defaultCeiling: String(tvSetVectors.count))),
